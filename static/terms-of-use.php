...
<div style="float:left;">
        ...
        <div class="tab-heading">&nbsp;</div>
            <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                <li class="ui-state-default ui-corner-top"><a href="#direct">Direct access</a></li>
                <li class="ui-state-default ui-corner-top"><a href="#public">Public use</a></li>
            ...
            <div id="other">
                ...
                <p>One approach to making it possible for users to conduct analyses of confidential data is creating a process that enables them to submit data processing and analysis programs remotely to the data depositor. The user is given a synthetic dataset that replicates the structure and content of the actual datasets. This enables the researcher to develop programs using tools such as SAS, SPSS or Stata. The programs are then transmitted to the data depositor staff, who run the job against the actual dataset. The results are then vetted for disclosure and returned to the user.</p>
