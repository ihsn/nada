...
<div style="float:left;">
        ...
        <div class="tab-heading">&nbsp;</div>
            <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                <li class="ui-state-default ui-corner-top"><a href="#acquisition">Acquisition</a></li>
                <li class="ui-state-default ui-corner-top"><a href="#preparation">Preparation</a></li>
                <li class="ui-state-default ui-corner-top"><a href="#documentation">Documentation</a></li>
                <li class="ui-state-default ui-corner-top"><a href="#cataloging">Cataloging</a></li>
                <!--<li class="ui-state-default ui-corner-top"><a href="#dissemination">Dissemination</a></li>-->
                <li class="ui-state-default ui-corner-top"><a href="#preservation">Preservation</a></li>
            </ul>
            <div id="acquisition">
...
<h3><a href="http://ihsn.org/home/index.php?q=tools/toolkit">IHSN Microdata Management Toolkit</a></h3>
