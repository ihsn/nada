<div class="footer-bar">
    ...
    <button class="btn-chart-options btn xbtn-outline-primary btn-sm text-secondary collapsed" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        ...
        <!--<svg aria-hidden="true" width="1em" height="1em" focusable="false" data-prefix="fas" data-icon="share" class="svg-inline--fa fa-share fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 516 516"><path fill="currentColor" d="M503.691 189.836L327.687 37.851C312.281 24.546 288 35.347 288 56.015v80.053C127.371 137.907 0 170.1 0 322.326c0 61.441 39.581 122.309 83.333 154.132 13.653 9.931 33.111-2.533 28.077-18.631C66.066 312.814 132.917 274.316 288 272.085V360c0 20.7 24.3 31.453 39.687 18.164l176.004-152c11.071-9.562 11.086-26.753 0-36.328z"></path></svg>-->
        Share chart
    </button>
        
  </div>
  <div class="collapse" id="collapseExample" style="position: absolute; bottom: 0px; width: 100%;">
  <div class="card-x card-body-x" style="background:gainsboro;padding:15px;">
    <button type="button" class="close float-right collapsed" aria-label="Close" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        ...
        <div class="form-group">
            <label for="default_options">Embed link with default settings</label>
            <div class="input-group mb-2">                    
                <input type="text" class="form-control form-control-sm" id="default_options" placeholder="Default options">
