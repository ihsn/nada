...
<form style="background-color:#E6E6E6;padding:10px;margin-bottom:20px;" id="form_report">	
    ...
    <input type="text" name="from" id="from" size="30" maxlength="15" class="date" value="<?php echo $this->input->xss_clean($this->input->get("from")); ?>"/>
    
    <label for="to"><?php echo t('to');?></label>
    <input type="text" name="to" id="to" size="30" maxlength="15" class="date" value="<?php echo $this->input->xss_clean($this->input->get("to")); ?>"/>
