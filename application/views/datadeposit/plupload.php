...
li.plupload_delete a {
	background: url('../projects/images/delete.gif');
}

li.plupload_failed a {
	background: url('../projects/images/error.gif');
	cursor: default;
}

li.plupload_done a {
	background: url('../projects/images/done.gif');
	cursor: default;
}
...
$(function() {
	...
	//	runtimes : 'gears,flash,silverlight,browserplus,html5',
		url : 'http://localhost/nada/index.php/admin/managefiles/1/process_batch_uploads',
		max_file_size : '300mb',
		chunk_size : '2mb',
		unique_names : false,
