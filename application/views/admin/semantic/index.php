...
<?php if ($use_vite_dev): ?>
<?php echo render_vite_dev_scripts('admin/semantic/main.js', $vite_dev_url); ?>
<?php else: ?>
<?php echo render_vite_entry_assets('admin_semantic', 'frontend/dist'); ?>
<?php endif; ?>
