...
?>
<div id="admin-datadeposit-app"></div>
<script>
window.APP_CONFIG = {
...
<?php if ($use_vite_dev): ?>
<?php echo render_vite_dev_scripts('admin/datadeposit/main.js', $vite_dev_url); ?>
<?php else: ?>
<?php echo render_vite_entry_assets('admin_datadeposit', 'frontend/dist'); ?>
<?php endif; ?>
