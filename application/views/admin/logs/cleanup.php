            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <button 
                            @click="startCleanup" 
                            :disabled="processing || (cleanupStatus && cleanupStatus.rows_processed > 0 && cleanupStatus.status !== 'completed' && cleanupStatus.status !== 'stopped' && cleanupStatus.status !== 'failed')"
