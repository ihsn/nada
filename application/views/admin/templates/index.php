<?php
// Admin Display templates UI – Vue 3 + Vite entry point
...
?>
<div id="admin-templates-app"></div>
<script>
window.APP_CONFIG = {
...
<?php if ($use_vite_dev): ?>
<?php echo render_vite_dev_scripts('admin/templates/main.js', $vite_dev_url); ?>
<?php else: ?>
<?php echo render_vite_entry_assets('admin_templates', 'frontend/dist'); ?>
<?php endif; ?>
