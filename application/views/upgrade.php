...
<code>
<span class="bg">application/config/upgrade.php</span>
<pre>
...
<p>Click on the upgrade button after you have made changes to the database.php and upgrade.php.</p>
<form method="post">
<p><input type="submit" name="upgrade" value="Run upgrade script"/></p>
</form>
</body>
</html>