...
<h2><?php echo t('general_site_settings');?></h2>
...
<div class="field">
        <label for="<?php echo 'cache_folder'; ?>"><?php echo t('cache_folder');?></label>
        <input class="input-flex" name="cache_folder" type="text" id="cache_folder"  value="<?php echo get_form_value('cache_folder',isset($cache_folder) ? $cache_folder : ''); ?>"/>
        <?php echo folder_exists($cache_folder);?>
</div>

<h2><?php echo t('use_html_editor_for_html');?></h2>
<div class="field" >
...
<h2><?php echo t('survey_catalog_settings');?></h2>
<div class="field">
...
<?php if (1>1):?>
<!-- 
<h2><?php echo t('mail_settings');?></h2>
<div class="field">
...
<div class="field">
        <label for="<?php echo 'smtp_username'; ?>"><?php echo t('smtp_user');?></label>
        <input class="input-flex" name="smtp_username" type="text" id="smtp_username"  value="<?php echo get_form_value('smtp_username',isset($smtp_username) ? $smtp_username : ''); ?>"/>
</div>

<div class="field">
        <label for="<?php echo 'smtp_password'; ?>"><?php echo t('smtp_password');?></label>
        <input class="input-flex" name="smtp_password" type="text" id="smtp_password"  value="<?php echo get_form_value('smtp_password',isset($smtp_password) ? $smtp_password : ''); ?>"/>
</div>
 -->
<?php endif;?>
