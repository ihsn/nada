...
.header{padding:15px;background-color:black;color:white;font-size:20px;}
...
<div id="translation-files">
    ...
    <div>
        <input type="radio" name="file" value="<?php echo $value;?>" <?php echo ($this->file==$value) ? 'checked="checked"' : '';?>  />
