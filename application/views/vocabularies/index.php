...
<div class="text-right page-links">
	<a href="<?php echo site_url(); ?>/admin/vocabularies/add" class="btn btn-outline-primary btn-sm">
    	<span class="fas fa-plus" aria-hidden="true"></span> <?php echo t('add_vocabulary'); ?></a>
</div>
