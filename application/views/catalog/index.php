    ...
    <tr>
        <td>
            <select id="batch_actions">
                ...
                <option value="publish"><?php echo t('publish_study');?></option>
                <option value="unpublish"><?php echo t('unpublish_study');?></option>
...
<table class="grid-table" width="100%" cellspacing="0" cellpadding="0">
    ...
    <?php foreach($rows as $row): ?>
        ...
        <tr class="study-info hide" id="s_<?php echo $row['id']; ?>_info">
        	<td class="study-info-box" colspan="<?php echo ($this->config->item("regional_search")=='yes') ? '7': '5'; ?>">--survey-info-box--</td>
        </tr>
    <?php endforeach;?>
</table>    
