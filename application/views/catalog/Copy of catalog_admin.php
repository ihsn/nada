...
<td style="width:180px;">
	<div class="filter-box">
    	<?php $filter_fields=array("repositoryid","nation","producer");?>
        <?php foreach($filter_fields as $field):?>
        	<div class="filter-field">
            	<h2 class="filter-title"><?php echo $field;?></h2>
                <div>
					<?php $values=create_filter($field);?>
                    <ul>
                    <?php foreach($values as $value):?>
                        <li><a href="<?php echo site_url();?>/admin/catalog/?field=<?php echo urlencode($field);?>&keywords=<?php echo urlencode($value);?>"><?php echo $value;?></a></li>
                    <?php endforeach;?>
                    </ul>
                </div>                
            </div>
