...
<div class="form-group">
    <label for="alt_title"><?php echo t('Editor work title');?></label>
    <input name="alt_title" type="text" id="alt_title" size="50" class="form-control"  value="<?php echo get_form_value('alt_title',isset($alt_title) ? $alt_title: ''); ?>"/>
</div>
...
<div class="content edit-anthology-translator  top-margin-10">
	<div class="row">
    <div class="col-md-6">
	<div class="form-group">	
