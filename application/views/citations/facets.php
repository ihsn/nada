<form name="search_form" id="search_form" method="get" autocomplete="off">        
    ...
    <div class="refine-list filter-container">
        ...
        <div class="sidebar-filter wb-ihsn-sidebar-filter filter-box keyword-search">
            <h6 class="togglable"> <i class="fa fa-search pr-2"></i><?php echo t('Search by keyword');?></h6>
            <div id="search-by-keyword" class="search-by-keyword sidebar-filter-entries">
                <div class="form-group study-search">
                    <input maxlength="100" type="text" id="keywords" name="keywords" value="<?php echo form_prep($this->input->get('keywords')); ?>" class="form-control" placeholder="<?php echo form_prep(t('keywords'));?>">
        ...
        <div id="filter-by-access" class="sidebar-filter wb-ihsn-sidebar-filter filter-by-year filter-box">
            <h6 class="togglable"> <i class="fa fa-search pr-2"></i><?php echo t('Filter by Year');?></h6>
            <div class="sidebar-filter-entries">        
                      
                <div class="form-inline-x">
                    <div class="form-group col">
                        <label for="year_from"><?php echo t('From');?></label>
                    ...
                    <div class="form-group col">
                        <label for="year_to"><?php echo t('To');?></label>
                ...
                <div class="form-group col">
                    <button class="btn btn-primary btn-sm"><?php echo t('Apply');?></button>
                </div>    
            </div>
        </div>
        ...
        <h6 class="togglable"> <i class="fa fa-filter pr-2"></i> <?php echo t('Filter by type');?></h6>
