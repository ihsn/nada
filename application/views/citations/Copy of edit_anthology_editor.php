...
<table border="0" class="inline-fields">
    ...
    <td>
    <div class="field">
        <label for="place_publication"><?php echo t('publishing_city');?></label>
    ...
    <td>
    <div class="field">
        <label for="place_state"><?php echo t('country_or_state');?></label>
    ...
    <td>
    <div class="field">
        <label for="publication_date"><?php echo t('publication_year');?></label>
        <input name="publication_date" type="text" id="publication_date" size="50" class="input-flex" value="<?php echo get_form_value('publication_date',isset($publication_date) ? $publication_date: ''); ?>"/>
    </div>
    </td>
