...
<div class="container-fluid">
		...
		<div class="text-right page-links">
				<a href="<?php echo site_url(); ?>/admin/regions/add" class="btn btn-outline-primary btn-sm">
				<span class="fas fa-plus ico-add-color right-margin-5" aria-hidden="true"></span> <?php echo t('create_region'); ?></a>
		</div>
	...
	<h3 class="page-title mt-5 mb-3"><?php echo t('Regions'); ?></h3>
