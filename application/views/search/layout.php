...
<form method="get" id="catalog-search-form">    
    ...
    <input type="hidden" name="page" id="page" value="<?php echo form_prep($search_options->page);?>"/>
    <?php //endif;?>
    <input type="hidden" name="view" id="view" value="<?php echo form_prep($search_options->view);?>"/>
