...
require_once("modules/bibtex/PARSECREATORS.php");
require_once "modules/bibtex/PARSEENTRIES.php";
require_once "modules/bibtex/PARSEMONTH.php";
require_once "modules/bibtex/PARSEPAGE.php";
