...
# Change back the allowed entities in our entity whitelist
    ...
    //$string = preg_replace_callback('/&amp;([A-Za-z][A-Za-z0-9]{0,19});/','&\\1;', $string);
    $string = preg_replace_callback('/&amp;([A-Za-z]{2,8}[0-9]{0,2});/', 'wp_kses_named_entities', $string);
    //$string = preg_replace_callback('/&amp;#0*([0-9]{1,5});/e','kses_normalize_entities2', $string);
    $string = preg_replace_callback('/&amp;#(0*[0-9]{1,7});/', 'kses_normalize_entities2', $string);
    //$string = preg_replace_callback('/&amp;#([Xx])0*(([0-9A-Fa-f]{2}){1,2});/', '&#\\1\\2;', $string);
...
function wp_kses_named_entities($matches) {
    ...
    //var_dump($allowedentitynames);die();
...
/* End of file kses_helper.php */
/* Location: ./application/helpers/kses_helper.php */