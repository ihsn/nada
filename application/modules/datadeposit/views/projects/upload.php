...
<h2><?php echo t('upload'); ?></h2>
<form style="margin-top:20px" method="post" enctype="multipart/form-data" class="form">
<?php /*
...
$(function() {
	...
	$("#uploader").pluploadQueue({
		...
		url : 'http://localhost/nada/index.php/projects/process_batch_uploads/<?php echo (int) $this->uri->segment(3); ?>',
		...
		filters : [
			...
			{title : "Resources", extensions : "jpg,gif,png,zip,doc,docx,pdf,sav,dta"}
		...
		init : {
			...
			UploadComplete: function (up, file) {
				...
				window.location = "<?php echo site_url(), '/projects/datafiles/', $id; ?>";
			},
...
<a style="font-size:11pt;margin-top:10px;float:right" href="<?php echo site_url(), '/projects/datafiles/', $id; ?>">Go Back</a>
