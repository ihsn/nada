...
<!--<a class="btn_cancel" href="<?php echo site_url("projects/study_description/$id");?>">Go Back</a>-->
<a class="btn_cancel" href="<?php echo site_url("projects");?>">Go Back</a>
</div>
<div id="feedback_header">
<h1 class="page-title"><?php echo '<em>', $title, '</em>', ' - Feedback';?></h1> 
</div>
<div class="contents">
