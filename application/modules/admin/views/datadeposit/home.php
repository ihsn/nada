...
<h1 class="page-title"><?php echo t('projects'); ?></h1>
<div style="font-size:11pt;margin-bottom:6px;text-align:right">
    <a href="<?php echo site_url(); ?>/datadeposit/create" ><?php echo t('add_new_project');?></a>
</div>
...
<table class="grid-table" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr valign="top" align="left" style="height:5px" class="header">
						...
						<th >
				                ...
				                <a href="<?php echo site_url('datadeposit/projects'); ?>?sort_by=shortname&sort_order=<?php if (isset($_GET['sort_order'])) echo ($_GET['sort_order']=='asc') ? 'desc' : 'asc';?>">Short name</a>			</th>

						<th >

				                <a class="selected" href="<?php echo site_url('datadeposit/projects'); ?>?sort_by=created_on&sort_order=<?php if (isset($_GET['sort_order'])) echo ($_GET['sort_order']=='asc') ? 'desc' : 'asc';?>">Created on <img src="<?php echo site_url(); ?>/../images/arrow-asc.png" alt="ASC" border="0"/></a>			</th>

						<th  >

				                <a href="<?php echo site_url('datadeposit/projects'); ?>?sort_by=created_by&sort_order=<?php if (isset($_GET['sort_order'])) echo ($_GET['sort_order']=='asc') ? 'desc' : 'asc';?>">Created by</a>			</th>

						<th >

				                <a href="<?php echo site_url('datadeposit/projects'); ?>?sort_by=collaborators&sort_order=<?php if (isset($_GET['sort_order'])) echo ($_GET['sort_order']=='asc') ? 'desc' : 'asc';?>">Collaborators</a>			</th>
