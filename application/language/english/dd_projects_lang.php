...
$lang['email_project'] = 'Email project summary';
$lang['email_user_shared_project'] = '<p>%s has shared a data deposit project summary for <b>%s</b> with you.</p>';
$lang['email_max_recipients'] = 'You can send to at most 5 email addresses.';
$lang['review'] = 'Review';
...
$lang['dd_required_missing'] = 'Required fields not filled';
$lang['dd_cannot_submit'] = 'Fix the items listed above before submitting.';
$lang['dd_validation_issues'] = 'Validation issues';
$lang['dd_pending_tasks'] = 'Pending tasks';
$lang['dd_submit_confirm'] = 'Submit this project? You will not be able to edit it until it is reopened.';
$lang['dd_access_and_notes'] = 'Access and notes';
$lang['dd_no_files_uploaded'] = 'No files uploaded.';
$lang['dd_files_help'] = 'Upload data files, questionnaires, reports, and other materials. After a file is uploaded, you can optionally add a type, title, and description.';
$lang['dd_drop_zone'] = 'Drop files here or click to browse';
$lang['dd_allowed_types'] = 'Allowed file types';
$lang['dd_uploaded_files'] = 'Uploaded files';
$lang['dd_add_details'] = 'Add details';
$lang['dd_edit_details'] = 'Edit details';
$lang['dd_resource_details'] = 'Resource details';
$lang['dd_no_details'] = 'No details';
$lang['dd_delete_selected'] = 'Delete selected';
$lang['dd_confirm_delete_file'] = 'Delete this file?';
$lang['dd_confirm_delete_files'] = 'Delete the selected files?';
$lang['dd_no_file_selection'] = 'No files selected.';
$lang['dd_upload_failed'] = 'Upload failed';
$lang['dd_file_type_not_allowed'] = 'This file type is not allowed.';
$lang['dd_file_too_large'] = 'This file is larger than the allowed maximum.';
$lang['dd_max_file_size'] = 'Max file size';
$lang['dd_retry_upload'] = 'Retry';
$lang['dd_start_project'] = 'To start depositing data, create a new project.';
$lang['dd_project_type_help'] = 'Select the kind of data you are depositing.';
$lang['dd_created_on'] = 'Date created';
$lang['dd_last_modified'] = 'Last modified';
$lang['dd_send'] = 'Send';
$lang['dd_email_to'] = 'Email addresses';
$lang['dd_email_to_help'] = 'Enter up to 5 email addresses.';
$lang['dd_email_will_send'] = 'The current project summary will be included in the message.';
$lang['dd_export'] = 'Export';
$lang['dd_export_ddi'] = 'DDI/XML';
$lang['dd_export_json'] = 'Metadata (JSON)';
$lang['dd_export_project_json'] = 'Project (JSON)';
$lang['dd_export_rdf'] = 'External resources (RDF)';
$lang['dd_export_external_json'] = 'External resources (JSON)';
$lang['dd_export_package'] = 'Download package';
$lang['dd_import_metadata'] = 'Import metadata';
$lang['dd_import_metadata_help'] = 'This replaces the current study description and cannot be undone.';
$lang['dd_import_from_project'] = 'From a project';
$lang['dd_import_from_file'] = 'From a JSON file';
$lang['dd_import_search'] = 'Search by title, short name, or project ID';
$lang['dd_import_hint'] = 'Type at least two characters, or a project ID.';
$lang['dd_import_empty'] = 'No matching projects of this type.';
$lang['dd_import_file'] = 'JSON file';
$lang['dd_import_file_help'] = 'Use a Metadata (JSON) or Project (JSON) export, or a Metadata Editor JSON of the same type.';
$lang['dd_import_file_invalid'] = 'That file is not valid JSON.';
$lang['dd_import_file_large'] = 'File is too large (maximum 2 MB).';
$lang['dd_import_run'] = 'Import';
$lang['dd_project_id'] = 'Project ID';
$lang['dd_reopen_reason'] = 'Reason for reopening';
$lang['dd_reopen_requested'] = 'Reopen requested';
$lang['dd_showing_range'] = 'Showing %s–%s of %s';
$lang['dd_na'] = 'N/A';
$lang['dd_status'] = 'Status';
$lang['dd_submitted'] = 'Submitted';
$lang['dd_processed'] = 'Processed';
$lang['dd_accepted'] = 'Accepted';
$lang['dd_closed'] = 'Closed';
$lang['dd_active_tasks'] = 'Active tasks';
$lang['dd_my_tasks'] = 'My tasks';
$lang['dd_task_info'] = 'Task info';
$lang['dd_task_status'] = 'Task status';
$lang['dd_assigned_to'] = 'Assigned to';
$lang['dd_assigned_by'] = 'Assigned by';
$lang['dd_assigned_on'] = 'Assigned on';
$lang['dd_completed_on'] = 'Completed on';
$lang['dd_date_assigned'] = 'Date assigned';
$lang['dd_date_completed'] = 'Date completed';
$lang['dd_update_status'] = 'Update status';
$lang['dd_wip'] = 'Work in progress';
$lang['dd_completed'] = 'Completed';
$lang['dd_assign_task'] = 'Assign task';
$lang['dd_tasks_assigned_others'] = 'Tasks assigned to others';
$lang['dd_recently_completed'] = 'Recently completed tasks';
$lang['dd_confirm_delete_task'] = 'Unassign this task from “%s”?';
$lang['dd_confirm_delete_project'] = 'Delete “%s”? This cannot be undone.';
$lang['dd_confirm_delete_projects'] = 'Delete %s projects? %s This cannot be undone.';
$lang['dd_project_not_found'] = 'Project was not found';
$lang['dd_log_history'] = 'Log history';
$lang['dd_files_in_folder'] = 'Files in project folder';
$lang['dd_files_located_at'] = 'Project files located at';
$lang['dd_assign_study_id'] = 'Assign study ID';
$lang['dd_email_compose_placeholder'] = 'Your email message to the user…';
$lang['dd_showing_projects'] = 'Showing';
$lang['dd_select_project'] = 'Select at least one project.';
$lang['dd_access_denied'] = 'Access denied';
$lang['dd_request_failed'] = 'Request failed';
$lang['dd_changed'] = 'Changed';
$lang['dd_created'] = 'Created';
$lang['dd_creator'] = 'Creator';
$lang['dd_projects_heading'] = 'Data deposit projects';
$lang['dd_no_selection'] = 'No selection';
$lang['dd_process_updated'] = 'Project status updated successfully!';
$lang['dd_email_notify_failed'] = 'Notification email was not sent.';
$lang['dd_project'] = 'Project';
$lang['dd_identity'] = 'Identity';
$lang['dd_date'] = 'Date';
$lang['dd_resolve'] = 'Resolve';
$lang['dd_reopen_task'] = 'Re-open';
$lang['dd_assign'] = 'Assign';
$lang['dd_not_set'] = 'NOT-SET';
$lang['dd_task_not_found'] = 'Task was not found';
$lang['dd_no_files_attached'] = 'There are no files attached to this project';
$lang['dd_history'] = 'History';
...
$lang['datadeposit_not_enabled'] = 'Data deposit is not enabled';
$lang['datadeposit_not_enabled_help'] = 'Set enable_datadeposit to true in application/config/datadeposit.php, then reload this page.';
