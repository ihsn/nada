...
//			$this->db->where('id',$id);		
	...
	**/
	...
	{				
		...
		$this->form_validation->set_rules('long_text', t('long_text'), 'trim|xss_clean|max_length[1000]');
		...
		$this->form_validation->set_rules('ispublished', t('published'), 'xss_clean|trim|max_length[1]|is_natural');			
