...
<?php
/**
 * Lean asset head for the public Vue catalog search page.
 * Keeps Bootstrap / jQuery / Font Awesome for site header/footer chrome.
 * Skips Google Fonts, home.css, and classic catalog CSS (facets/cards/tabs).
 */
?>
