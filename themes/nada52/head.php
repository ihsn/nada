...
<link rel="stylesheet" href="<?php echo base_url().$bootstrap_theme ?>/css/catalog-card.css?v07052021-4">
<link rel="stylesheet" href="<?php echo base_url().$bootstrap_theme ?>/css/filter-action-bar.css?v14052021-1">
