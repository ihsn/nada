<?php
/**
 * Minimal head for iframe table embed: no site Bootstrap/jQuery/theme CSS.
 * The Vue entry (render_vite_* in catalog/study_indicator_data_public.php) loads JS/CSS for the table app.
 */
...
<style>
	...
	html.embed-table-html body.embed-catalog-table {
		margin: 0;
		padding: 0;
		width: 100%;
		min-height: 100vh;
	...
	body.embed-catalog-table .embed-table-body {
		flex: 1 1 0%;
		min-height: 0;
		width: 100%;
		max-width: 100%;
