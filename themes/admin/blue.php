...
if ($languages!==FALSE)
{
	if (count($languages)>1)
	{
		...
		{
			$lang_list.='| <span> '.anchor('switch_language/'.$language.'/?destination='.uri_string(), strtoupper($language)).' </span>';
		}
	}
}
?>
...
<div id="doc3">
   ...
   <div id="hd">
       ...
       <div id="header" role="banner" style="padding-top:20px;padding-bottom:10px;">
                <span style="color:white;font-size:24px;padding:5px;margin-left:20px;margin-top:20px;"><?php echo t('nada_administration');?></span>
      </div>
                ...
                <div id="navcontainer">
                        ...
                        <li><a <?php echo ($selected_page=='vocabularies') ? 'class="active"' : ''; ?>  href="<?php echo site_url("admin/vocabularies");?>"><?php echo t('vocabularies');?></a></li>
