...
<div id="doc3" class="yui-t2" > 
    ...
    <!-- header -->
    <div id="hd" >
        <div style="background:url(themes/<?php echo $this->template->theme();?>/rostat-header.jpg) no-repeat;background-color:#497EA6;height:151px;">
            <!-- logo -->
            <div class="site-logo" >
    ...
    <!-- footer -->
    <div id="ft">Демонстрационный сайт разработан Международным сети обследований домашних хозяйств (МСОД)</div>
