...
<!--
Ths tarnsform produces an HTML data collection output of a DDI 1/2.x XML document

Author: Mehmood Asghar, Pascal Heus
Version: August 2009
Platform: XSL 1.0
...
<xsl:stylesheet version="1.0" xmlns:ddi="http://www.icpsr.umich.edu/DDI" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="ddi:stdyDscr//ddi:collMode">
		<tr valign="top">
			<td colspan="2"><div class="xsl-subtitle"><xsl:call-template name="gettext"><xsl:with-param name="msg">Data Collection Mode</xsl:with-param></xsl:call-template></div>
				<xsl:value-of select="."/>
			</td>
		</tr>
	</xsl:template>	
